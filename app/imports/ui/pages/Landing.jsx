    ...
    return (
        <div>
          <div className="background-site">
            <div className="ui center aligned container container-width">
          ...
          <div>
            ...
            <Header/>
              <Grid container columns={2}>
                <Grid.Column>
                  <p className="Nunito-font font-medium text-align-right margin-bottom-minus-10"><span className="font-bold">Why use Stud</span>Budd?</p>
